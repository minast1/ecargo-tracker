...
const DisplayOrderResults = () => {
    ...
    return (
       <Paper square sx={{backgroundColor: 'paper', p:1, height: 320 , boxShadow: 12}}>
            ...
            <Container maxWidth="lg" sx={{border:'1px solid lightgray', mt:5}}>
                <Grid container spacing={2} alignItems="center" sx={{py:1}}>
                    <Grid item xs={3}>
                        ...
                        <Typography sx={{ fontSize: '15px', color: 'lightslategray' }}>{data.awb}</Typography>
                    </Grid>
                    <Grid item xs={3}>
                    ...
                    <Grid item xs={3}>
                       <Typography sx={{ fontSize: '16px', fontWeight: 'bold' }}>Estimated Delivery Time:</Typography>
                        <Typography sx={{ fontSize: '15px', color: 'lightslategray' }}>{ data.createdAt}</Typography>
                    </Grid>
                    <Grid item xs={3}>
